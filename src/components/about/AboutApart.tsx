...
function FeatureIcon() {
  return (
    <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-grid-border">
      ...
      <SectionContainer className="pb-8 lg:pb-12">
        ...
        <div className="card-grid grid w-full grid-cols-1 md:grid-cols-3">
          {features.map((feature) => (
            <article key={feature.title} className="card-interactive bg-white p-8 text-left lg:p-10">
              <FeatureIcon />
