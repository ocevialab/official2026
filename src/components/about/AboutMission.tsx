      ...
      <SectionContainer className="pb-8 lg:pb-12">
        <div className="relative py-14 lg:py-20">
          ...
          <div className="max-w-4xl">
            <h2 className="text-2xl font-bold leading-snug text-ink md:text-3xl lg:text-4xl">
        ...
        <div className="card-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat) => (
            <div key={stat.value} className="card-interactive bg-white px-6 py-10 lg:px-10 lg:py-12">
